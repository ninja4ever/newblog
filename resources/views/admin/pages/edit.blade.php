      ...
      {!! Form::model($page,['url' => '/admin/pages/update/'.$page->id, 'method' => 'post', 'class'=>'form-horizontal', 'files'=>true]) !!}
            ...
            <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                {!! Form::label('body', trans('messages.page_body_label'), ['class' => 'col-md-4 control-label']) !!}
                 <div class="col-md-6">
                   <textarea name="body" rows="5" cols="40" id="body" class="form-control">{!!$page->body!!}</textarea>
            ...
            <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
              {!! Form::label('image', trans('messages.page_page_image_label'), ['class' => 'col-md-4 control-label']) !!}
                <div class="col-md-6">
                  ...
                  <img id="image-preview" src="{{asset('uploads/pages-image/'.$page->image)}}" alt="image_prewiew" style="display:block;"/>
                    @if ($errors->has('image'))
                        <span class="help-block">
